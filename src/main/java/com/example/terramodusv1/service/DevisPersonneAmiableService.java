...
public class DevisPersonneAmiableService {
    ...
    public DevisPersonneAmiable saveDevise(DevisPersonneAmiable devise) throws MessagingException, jakarta.mail.MessagingException, JRException, IOException, ParseException, XmlException {
        ...
        String[] plaaceholders = new String[]{"VILLE", "REF", "NDEVIS", "DATE", "TEEV", "TITRE", "IMMOB", "ADRESSE", "DIST", "PTFrais","PEI","PrixChiffres"};
        ...
        for (XWPFParagraph paragraph : cel2.getParagraphs()) {
            for (XWPFRun run : paragraph.getRuns()) {
                ...
                if(runText.contains("BIEN")) {
                    runText = runText.replace("BIEN",bien);
                    run.setText(runText, 0);
                }
